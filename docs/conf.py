...
"""
openedx-cmi5-xblock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-cmi5-xblock',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx-cmi5-xblock/openedx-cmi5-xblock",
...
#
# html_title = 'openedx-cmi5-xblock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Openedx CMI5 XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_cmi5_xblock'),
                os.path.join(root_path, 'openedx_cmi5_xblock/migrations')])
